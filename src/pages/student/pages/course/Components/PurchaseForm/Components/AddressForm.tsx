  ...
  return (
    <>
      <fieldset className=" text-black grid gap-3">
        ...
        <div className="space-y-3 md:space-y-0 md:flex gap-3">
          <div>
            <label htmlFor="identityNumber" className=" grow w-full">
              <input
                type="tel"
                name="identityNumber"
                id="identityNumber"
              ...
              />
              <p className=" text-[red] text-xs">
                {errors?.identityNumber ? errors.identityNumber[0] : ""}
              </p>
            </label>
          </div>
          <div>
        ...
        <div>
          ...
          <p className=" text-[red] text-xs">
            {errors?.registrationAddress ? errors.registrationAddress[0] : ""}
          </p>
        </div>
      </fieldset>
